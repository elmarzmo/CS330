...
void SceneManager::LoadSceneTextures()
{
	...
	/*** the OpenGL Sample for help.                                 ***/
		...
		bReturn = CreateGLTexture("textures/gold.jpg", "cylinder");
		bReturn = CreateGLTexture("textures/circular-brushed-gold-texture.jpg", "box");
		bReturn = CreateGLTexture("textures/wood.jpg", "secBox");
		bReturn = CreateGLTexture("textures/blue.jpg", "sphere");
		bReturn = CreateGLTexture("textures/red.jpg", "cone");
...
void SceneManager::RenderScene()
{
	...
	// Set the shader texture to the floor texture 
	...
	// Set the shader texture to the cylinder texture 
	// 	
	...
	// Set the shader texture to the box texture 
	SetShaderTexture("secBox");
	...
	// Set the shader texture to the sphere texture 
	...
	// Set the shader texture to the cone texture 
